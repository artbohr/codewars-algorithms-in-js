function bingo(a) {
    return ([...new Set(a)].filter(x => [2,9,14,7,15].includes(x))).length==5 ? 'WIN' : 'LOSE';
  }
...
Each number corresponds to their alphabetical order letter (e.g. 1 = A. 2 = B, etc). Write a function
 where you will win the game if your numbers can spell "BINGO". They do not need to be in the right
