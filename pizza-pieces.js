...
And then some Italian friends appeared at her room.
...
If K is a negative number, the result must be -1 (or Nothing in Haskell).
Examples
max_pizza(0) == 1
max_pizza(1) == 2
max_pizza(3) == 7
